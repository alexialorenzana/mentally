...
‍Lowers
        ...
        <div className="text-center">
          <a
            href="/myHealth360"
            className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-ally2 transition duration-200 rounded shadow-md md:w-auto bg-deep-purple-accent-400 hover:bg-ally7 focus:shadow-outline focus:outline-none"
          >
           Read Articles
          </a>
        </div>
